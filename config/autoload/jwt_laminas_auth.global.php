...
return [
    'jwt_laminas_auth' => [
        ...
        */
        ...
        'signKey' => getenv('OPG_CORE_JWT_KEY') ? getenv('OPG_CORE_JWT_KEY') : 'Th15IsAF4kET3sTs3Cr3t!',
        // Set the key to verify the token with, value is dependent on signer set.
        'verifyKey' => getenv('OPG_CORE_JWT_KEY') ? getenv('OPG_CORE_JWT_KEY') : 'Th15IsAF4kET3sTs3Cr3t!',
        /*
